...
#ifndef XMIPP4_CUDA_CACHING_ALLOCATOR_MAX_ALIGNMENT_BYTES
	#define XMIPP4_CUDA_CACHING_ALLOCATOR_MAX_ALIGNMENT_BYTES 256UL
#endif
...
#ifndef XMIPP4_CUDA_CACHING_ALLOCATOR_MIN_HEAP_BYTES
	#define XMIPP4_CUDA_CACHING_ALLOCATOR_MIN_HEAP_BYTES (2UL << 20)
#endif
...
#ifndef XMIPP4_CUDA_CACHING_ALLOCATOR_MAX_HEAP_BYTES
	#define XMIPP4_CUDA_CACHING_ALLOCATOR_MAX_HEAP_BYTES (1UL << 30)
#endif
...
#ifndef XMIPP4_CUDA_CACHING_ALLOCATOR_LARGE_ALLOCATION_BYTES
	#define XMIPP4_CUDA_CACHING_ALLOCATOR_LARGE_ALLOCATION_BYTES (64UL << 20)
#endif
...
#ifndef XMIPP4_CUDA_CACHING_ALLOCATOR_SMALL_QUEUE_COUNT
	#define XMIPP4_CUDA_CACHING_ALLOCATOR_SMALL_QUEUE_COUNT 16UL
#endif
